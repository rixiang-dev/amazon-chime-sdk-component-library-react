...
interface Props {
  ...
  */
  videoDownlinkBandwidthPolicyWrapper?: (logger: Logger) => VideoDownlinkBandwidthPolicy;
...
export const MeetingProvider: React.FC<Props> = ({
  ...
  videoDownlinkBandwidthPolicyWrapper,
  meetingManager: meetingManagerProp,
  children,
}) => {
  const [meetingManager] = useState(
    () => meetingManagerProp || new MeetingManager({ logLevel, postLogConfig, simulcastEnabled, videoDownlinkBandwidthPolicyWrapper })
  );
